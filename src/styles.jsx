...
.af-modal{position:relative;background:var(--panel);border:1px solid var(--line2);border-radius:16px;padding:26px 24px;max-width:420px;width:100%;box-shadow:0 24px 60px rgba(0,0,0,.45);}
